...
//Funktionen zur Erstellung der einzelnen Komponenten
export function createButton({ text, variant, size }) { //variant : "primary", "secondary", "outlined" / size: "small", "medium", "large"  
...
export function createCard({ variant, size } = {}) {
  ...
  const contentText = //zweites Textfeld
